...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      // add await because we are using mongoose method
...
router.get('/github/:username', (req, res) => {
    try {
        const options = {
            uri: `https://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${config
